// app.js (ES module) - uses Firebase v9 modular SDK via CDN imports
...
/* ====== Replace with your firebase config ======
   Using the config you provided in the conversation.
   Ensure the Firebase project has Authentication (Email & Google) enabled
   and Firestore database created (in native mode).
*/
const firebaseConfig = {
  apiKey: "AIzaSyBl0RrLpU1OB4QaExD7c-Ayq7GZUtyBaTY",
  authDomain: "time-tracker-app-52c13.firebaseapp.com",
  databaseURL: "https://time-tracker-app-52c13-default-rtdb.asia-southeast1.firebasedatabase.app",
